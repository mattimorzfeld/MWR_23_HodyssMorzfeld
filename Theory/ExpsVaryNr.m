...
biasEnKF = zeros(length(nr),1);
biasEnKFnn = zeros(length(nr),1);
biasLocEnKF = zeros(length(nr),1);
biasLocEnKFnn = zeros(length(nr),1);
mseKF = zeros(length(nr),1);
mseEnKF = zeros(length(nr),1);
mseLocEnKF = zeros(length(nr),1);
biasPa11 = zeros(length(nr),1);
biasPa11Loc = zeros(length(nr),1);
biasPann = zeros(length(nr),1);
biasPannLoc = zeros(length(nr),1);
...
box on
grid on
saveas(gcf, 'fig3_biasGainObs.tif')
...
box on
grid on
saveas(gcf, 'fig3_excessPostVarObs.tif')
...
box on
grid on
saveas(gcf, 'fig3_excessPostVarUnobs.tif')
